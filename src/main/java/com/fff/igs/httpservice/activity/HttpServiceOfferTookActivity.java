...
@WebServlet(name = "HttpServiceOfferTookActivity", value = "/offertookactivity")
public class HttpServiceOfferTookActivity extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ServerResponse serverResp = serverMgr.tookOfferActivity(jsonDataObj);
