...
@WebServlet(name = "HttpServiceSaveActivity", value = "/saveactivity")
public class HttpServiceSaveActivity extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ServerResponse serverResp = serverMgr.saveActivity(jsonDataObj);
