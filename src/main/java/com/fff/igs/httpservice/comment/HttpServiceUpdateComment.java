...
@WebServlet(name = "HttpServiceUpdateComment", value = "/updatecomment")
public class HttpServiceUpdateComment extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ServerResponse serverResp = serverMgr.updateComment(comment);
